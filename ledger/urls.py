...
from .views import RecipeListView, RecipeDetailView, RecipeCreateView, RecipeImageAddView, IngredientAddView
...
urlpatterns = [
    ...
    path('new_ingredient/', IngredientAddView.as_view(), name = 'ingredient'),
]
